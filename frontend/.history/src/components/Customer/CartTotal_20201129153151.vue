  ...
  <v-container class="text-start admin">
    ...
    <v-row>
      ...
      <v-col>
        ...
        <br />
        <span> {{  Intl.NumberFormat("en-EN", { maximumSignificantDigits: 3 }).format(
            price
          ) }}</span>
        </div>
        
        <!-- <v-radio-group v-model="radioGroup" class=" ma-0 pl-5">
          <v-radio
        ...
        <a v-if="radioGroup=1" class="pl-5"> {{
          Intl.NumberFormat("en-EN", { maximumSignificantDigits: 3 }).format(
            500000
          )
        }} </a>
        <a v-else-if="radioGroup=2" class="pl-5"> {{
          Intl.NumberFormat("en-EN", { maximumSignificantDigits: 3 }).format(
            10000
          )
        }} </a> -->
